import React__default, { useState, useRef, useEffect, useCallback, createContext, createElement, memo, createRef, useContext, Fragment as Fragment$1, useMemo, Suspense, useLayoutEffect, Component } from "react";
...
const usePresence = (client) => {
  const [onlineMap, setOnlineMap] = useState(/* @__PURE__ */ new Map());
  useEffect(() => {
...
const useReadReceipts = (client, roomId) => {
  const [receipts, setReceipts] = useState(/* @__PURE__ */ new Map());
  useEffect(() => {
    if (!roomId) return;
...
const useReactions = (client, roomId) => {
  ...
  const getEmojis = useCallback((reactions) => {
...
const useUpload = (client) => {
  ...
  const validate = useCallback((file, maxMb = 50) => {
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              (onEdit || onDelete || onReact || onReply) && /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    isOwn && onDelete && /* @__PURE__ */ jsx(ActionBtn, { onClick: () => onDelete(message._id), title: "Delete", children: "🗑" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                      ...
                      "a",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs("div", { children: [
                            ...
                            /* @__PURE__ */ jsx("div", { style: { fontSize: 11, opacity: 0.7 }, children: formatFileSize$1(message.fileSize) })
                          ] })
                        ]
                      }
                    ),
              ...
              ((_a = message.reactions) == null ? void 0 : _a.filter((r) => r.users.length > 0).length) > 0 && /* @__PURE__ */ jsx(
                "div",
                {
...
const ActionBtn = ({ onClick, title, children }) => /* @__PURE__ */ jsx(
  "button",
  {
    onClick,
    title,
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(TypingIndicator$1, { typingUsers }),
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { style: { overflow: "hidden" }, children: [
                /* @__PURE__ */ jsx("span", { style: { fontWeight: 600, marginRight: 4 }, children: "Replying to:" }),
                /* @__PURE__ */ jsx("span", { style: { opacity: 0.7 }, children: replyingTo.type === "text" ? (_a = replyingTo.text) == null ? void 0 : _a.slice(0, 60) : `[${replyingTo.type}]` })
              ] }),
              /* @__PURE__ */ jsx(
                "button",
                {
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              onSendFile && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => {
                    ...
                    children: renderAttachIcon ? renderAttachIcon() : /* @__PURE__ */ jsx(
                      "svg",
                      {
                        width: "20",
                        height: "20",
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: renderSendIcon ? renderSendIcon() : /* @__PURE__ */ jsx("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" }) })
                }
              )
            ]
          }
        ),
        text.length > maxLength * 0.8 && /* @__PURE__ */ jsxs(
          "div",
          {
            style: {
              fontSize: 10,
...
const DefaultRoomItem = ({ room, isActive, currentUserId, renderAvatar, itemClassName }) => /* @__PURE__ */ jsxs(
  "div",
  {
    ...
    children: [
      /* @__PURE__ */ jsx("div", { style: { flexShrink: 0 }, children: renderAvatar ? renderAvatar(room) : /* @__PURE__ */ jsx(
        "div",
        {
          style: {
            width: 42,
...
const RoomList = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        (onCreateDirect || onCreateGroup) && /* @__PURE__ */ jsxs(
          "div",
          {
            style: {
              display: "flex",
        ...
        loading && /* @__PURE__ */ jsx("div", { style: { padding: "12px 16px", opacity: 0.5, fontSize: 13 }, children: "Loading rooms..." }),
        !loading && rooms.length === 0 && /* @__PURE__ */ jsx(
          "div",
          {
            style: {
              textAlign: "center",
        ...
        !loading && rooms.map((room) => {
          ...
          return /* @__PURE__ */ jsx("div", { onClick: () => onSelectRoom(room), children: renderRoomItem ? renderRoomItem(room, isActive) : /* @__PURE__ */ jsx(
            DefaultRoomItem,
            {
              room,
              isActive,
...
const TypingIndicator = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 3 }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsx(
          "span",
          {
            style: {
              width: 6,
        ...
        /* @__PURE__ */ jsx("span", { style: { fontSize: 12, opacity: 0.6 }, children: typingText }),
        /* @__PURE__ */ jsx("style", { children: `
        @keyframes hermes-bounce {
          0%, 80%, 100% { transform: translateY(0); }
...
function ViewOnlyEmoji(_ref) {
  ...
  return createElement(Fragment$1, null, emojiStyle === EmojiStyle.NATIVE ? createElement(NativeEmoji, {
    unified,
    style,
    className
...
function PreviewBody() {
  ...
  function PreviewContent() {
    ...
    return createElement(Fragment$1, null, createElement("div", null, show ? createElement(ViewOnlyEmoji, {
...
function ExpandedPickerContent(_ref) {
  ...
  return createElement(Fragment$1, null, createElement(Header, null), createElement(Body, null), createElement(Preview, null));
}
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              emojis2.map((emoji) => /* @__PURE__ */ jsx(
                "button",
                {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        message.type === "audio" && /* @__PURE__ */ jsxs(
          "div",
          {
            style: { display: "flex", alignItems: "center", gap: 8, padding: 8 },
            children: [
              /* @__PURE__ */ jsx("span", { style: { fontSize: 20 }, children: "🎵" }),
              /* @__PURE__ */ jsx("audio", { src: message.url, controls: true, style: { flex: 1, height: 36 } })
            ]
          }
        ),
        message.type === "document" && /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { style: { fontSize: 28, flexShrink: 0 }, children: "📄" }),
              /* @__PURE__ */ jsxs("div", { style: { overflow: "hidden" }, children: [
                /* @__PURE__ */ jsx(
                  "div",
                  {
        ...
        message.type === "link" && /* @__PURE__ */ jsxs(
          "a",
          {
            href: message.url,
            target: "_blank",
