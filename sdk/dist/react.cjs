...
const React__default = require("react");
const jsxRuntime = require("react/jsx-runtime");
const useMessages = (client, roomId) => {
  const [messages, setMessages] = React__default.useState([]);
  const [loading, setLoading] = React__default.useState(false);
  const [loadingMore, setLoadingMore] = React__default.useState(false);
  const [hasMore, setHasMore] = React__default.useState(false);
  const [error, setError] = React__default.useState(null);
  const [typingUsers, setTypingUsers] = React__default.useState([]);
  const oldestMessageId = React__default.useRef(void 0);
  ...
  const loadMore = React__default.useCallback(async () => {
  ...
  const sendMessage = React__default.useCallback(
    async (input) => {
  ...
  const editMessage = React__default.useCallback(
  ...
  const deleteMessage = React__default.useCallback(
    async (messageId) => {
      if (!roomId) throw new Error("No room selected");
  ...
  const addReaction = React__default.useCallback(
...
const useRooms = (client) => {
  const [rooms, setRooms] = React__default.useState([]);
  const [loading, setLoading] = React__default.useState(true);
  const [error, setError] = React__default.useState(null);
  const fetchedRef = React__default.useRef(false);
  const fetchRooms = React__default.useCallback(async () => {
    setLoading(true);
    setError(null);
  ...
  const createDirect = React__default.useCallback(
    async (input) => {
  ...
  const createGroup = React__default.useCallback(
    async (input) => {
  ...
  const deleteRoom = React__default.useCallback(
    async (roomId) => {
  ...
  const addMember = React__default.useCallback(
    (roomId, userId) => client.addMember(roomId, userId),
    [client]
  );
  const removeMember = React__default.useCallback(
...
const usePresence = (client) => {
  const [onlineMap, setOnlineMap] = React__default.useState(/* @__PURE__ */ new Map());
  React__default.useEffect(() => {
  ...
  const isOnline = React__default.useCallback(
...
const useTyping = (client, roomId) => {
  const [typingUsers, setTypingUsers] = React__default.useState(
    /* @__PURE__ */ new Map()
  );
  const timeouts = React__default.useRef(
    /* @__PURE__ */ new Map()
  );
  const typingRef = React__default.useRef(false);
  const stopTimeout = React__default.useRef(null);
  React__default.useEffect(() => {
    if (!roomId) return;
    const onStart = (event) => {
      var _a;
      if (event.roomId !== roomId) return;
      if (event.userId === ((_a = client.currentUser) == null ? void 0 : _a.userId)) return;
      setTypingUsers(
  ...
  const startTyping = React__default.useCallback(() => {
    if (!roomId) return;
  ...
  const stopTyping = React__default.useCallback(() => {
    if (!roomId) return;
    if (stopTimeout.current) clearTimeout(stopTimeout.current);
    if (typingRef.current) {
      client.stopTyping(roomId);
...
const useReadReceipts = (client, roomId) => {
  const [receipts, setReceipts] = React__default.useState(/* @__PURE__ */ new Map());
  React__default.useEffect(() => {
    if (!roomId) return;
  ...
  const markSeen = React__default.useCallback(
    async (lastMessageId) => {
      if (!roomId) return;
  ...
  const seenBy = React__default.useCallback(
    (messageId) => {
...
const useReactions = (client, roomId) => {
  const react = React__default.useCallback(
    async (messageId, emoji) => {
      if (!roomId) throw new Error("No room selected");
  ...
  const hasReacted = React__default.useCallback(
    (reactions, emoji) => {
      var _a, _b;
      const userId = (_a = client.currentUser) == null ? void 0 : _a.userId;
      if (!userId) return false;
      return ((_b = reactions.find((r) => r.emoji === emoji)) == null ? void 0 : _b.users.includes(userId)) ?? false;
    },
    [client]
  );
  const getCount = React__default.useCallback(
    (reactions, emoji) => {
      var _a;
      return ((_a = reactions.find((r) => r.emoji === emoji)) == null ? void 0 : _a.users.length) ?? 0;
    },
    []
  );
  const getEmojis = React__default.useCallback((reactions) => {
    return reactions.filter((r) => r.users.length > 0).map((r) => r.emoji);
  }, []);
  return { react, hasReacted, getCount, getEmojis };
};
const useUpload = (client) => {
  const [uploading, setUploading] = React__default.useState(false);
  const [error, setError] = React__default.useState(null);
  const [lastUpload, setLastUpload] = React__default.useState(null);
  const upload = React__default.useCallback(
    async (file) => {
      setUploading(true);
      setError(null);
      try {
  ...
  const sendFile = React__default.useCallback(
  ...
  const validate = React__default.useCallback((file, maxMb = 50) => {
...
const EmojiPicker$2 = ({ onPick, onClose, isOwn }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: REACTION_EMOJIS.map((emoji) => /* @__PURE__ */ jsxRuntime.jsx(
        "button",
        {
          onClick: () => {
            onPick(emoji);
...
const TypingIndicator$1 = ({ typingUsers }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 11, color: "#999" }, children: text })
      ]
    }
  );
};
const DefaultMessage = ({ message, isOwn, onEdit, onDelete, onReact, onReply, renderAvatar }) => {
  var _a;
  const [hovered, setHovered] = React__default.useState(false);
  const [pickerOpen, setPickerOpen] = React__default.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        !isOwn && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flexShrink: 0 }, children: renderAvatar ? renderAvatar(message.senderId) : /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              width: 32,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              (onEdit || onDelete || onReact || onReply) && /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  style: {
                    display: "flex",
                  ...
                  children: [
                    onReact && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative" }, children: [
                      /* @__PURE__ */ jsxRuntime.jsx(
                        ActionBtn,
                        {
                    ...
                    onReply && /* @__PURE__ */ jsxRuntime.jsx(ActionBtn, { onClick: () => onReply(message), title: "Reply", children: "↩" }),
                    isOwn && onEdit && message.type === "text" && /* @__PURE__ */ jsxRuntime.jsx(
                      ActionBtn,
                      {
                        onClick: () => {
                    ...
                    isOwn && onDelete && /* @__PURE__ */ jsxRuntime.jsx(ActionBtn, { onClick: () => onDelete(message._id), title: "Delete", children: "🗑" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  ...
                  children: [
                    message.replyTo && /* @__PURE__ */ jsxRuntime.jsx(
                      "div",
                      {
                        style: {
                    ...
                    message.type === "text" && /* @__PURE__ */ jsxRuntime.jsxs("p", { style: { margin: 0, wordBreak: "break-word" }, children: [
                      message.text,
                      message.editedAt && /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 10, opacity: 0.6, marginLeft: 6 }, children: "(edited)" })
                    ] }),
                    message.type === "link" && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                      message.text && /* @__PURE__ */ jsxRuntime.jsx("p", { style: { margin: "0 0 4px" }, children: message.text }),
                      /* @__PURE__ */ jsxRuntime.jsx(
                        "a",
                        {
                          href: message.url,
                    ...
                    message.type === "image" && /* @__PURE__ */ jsxRuntime.jsx(
                      "img",
                      {
                        src: message.url,
                    ...
                    message.type === "video" && /* @__PURE__ */ jsxRuntime.jsx(
                      "video",
                      {
                        src: message.url,
                        controls: true,
                    ...
                    message.type === "audio" && /* @__PURE__ */ jsxRuntime.jsx("audio", { src: message.url, controls: true, style: { width: "100%" } }),
                    message.type === "document" && /* @__PURE__ */ jsxRuntime.jsxs(
                      "a",
                      {
                        href: message.url,
                        target: "_blank",
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 24 }, children: "📄" }),
                          /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontWeight: 600, fontSize: 13 }, children: message.fileName }),
                            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 11, opacity: 0.7 }, children: formatFileSize$1(message.fileSize) })
                          ] })
                        ]
                      }
                    ),
              ...
              ((_a = message.reactions) == null ? void 0 : _a.filter((r) => r.users.length > 0).length) > 0 && /* @__PURE__ */ jsxRuntime.jsx(
                "div",
                {
                  style: { display: "flex", gap: 4, flexWrap: "wrap", marginTop: 4 },
                  children: message.reactions.filter((r) => r.users.length > 0).map((r) => /* @__PURE__ */ jsxRuntime.jsxs(
                    "span",
                    {
                      onClick: () => onReact == null ? void 0 : onReact(message._id, r.emoji),
                      style: {
                        background: "#f0f0f0",
...
const ActionBtn = ({ onClick, title, children }) => /* @__PURE__ */ jsxRuntime.jsx(
  "button",
  {
    onClick,
    title,
...
const MessageList = ({
  ...
  const bottomRef = React__default.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          hasMore && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { textAlign: "center", marginBottom: 12 }, children: loadingMore ? /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 12, opacity: 0.5 }, children: "Loading older messages..." }) : /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              onClick: onLoadMore,
              style: {
          ...
          messages.map((message) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { marginBottom: 8 }, children: renderMessage ? renderMessage(message, isOwn) : /* @__PURE__ */ jsxRuntime.jsx(
              DefaultMessage,
              {
                message,
                isOwn,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(TypingIndicator$1, { typingUsers }),
...
const ChatInput = ({
  ...
  const [sending, setSending] = React__default.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        replyingTo && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontWeight: 600, marginRight: 4 }, children: "Replying to:" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { opacity: 0.7 }, children: replyingTo.type === "text" ? (_a = replyingTo.text) == null ? void 0 : _a.slice(0, 60) : `[${replyingTo.type}]` })
              ] }),
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              onSendFile && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  "button",
                  {
                    onClick: () => {
                    ...
                    children: renderAttachIcon ? renderAttachIcon() : /* @__PURE__ */ jsxRuntime.jsx(
                      "svg",
                      {
                        width: "20",
                        height: "20",
                        ...
                        children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 18 8.84l-8.59 8.57a2 2 0 0 1-2.83-2.83l8.49-8.48" })
                      }
                    )
                  }
                ),
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "textarea",
                {
                  ...
                  onBlur: () => onTypingStop == null ? void 0 : onTypingStop(),
                  placeholder,
                  disabled,
                  maxLength,
                  rows: 1,
              ...
              /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
                  ...
                  children: renderSendIcon ? renderSendIcon() : /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" }) })
                }
              )
            ]
          }
        ),
        text.length > maxLength * 0.8 && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: {
              fontSize: 10,
...
const getLastMessagePreview = (room) => {
  ...
  if (msg.type === "text") return ((_a = msg.text) == null ? void 0 : _a.slice(0, 50)) ?? "";
...
const DefaultRoomItem = ({ room, isActive, currentUserId, renderAvatar, itemClassName }) => /* @__PURE__ */ jsxRuntime.jsxs(
  "div",
  {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: { flexShrink: 0 }, children: renderAvatar ? renderAvatar(room) : /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          style: {
            width: 42,
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { flex: 1, overflow: "hidden" }, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              ...
              room.unreadCount > 0 && /* @__PURE__ */ jsxRuntime.jsx(
                "span",
                {
                  style: {
                    background: "#0084ff",
...
const RoomList = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        (onCreateDirect || onCreateGroup) && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: {
              display: "flex",
            ...
            children: [
              onCreateDirect && /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
              ...
              onCreateGroup && /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
        ...
        loading && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { padding: "12px 16px", opacity: 0.5, fontSize: 13 }, children: "Loading rooms..." }),
        !loading && rooms.length === 0 && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              textAlign: "center",
        ...
        !loading && rooms.map((room) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsx("div", { onClick: () => onSelectRoom(room), children: renderRoomItem ? renderRoomItem(room, isActive) : /* @__PURE__ */ jsxRuntime.jsx(
            DefaultRoomItem,
            {
              room,
              isActive,
...
const TypingIndicator = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 3 }, children: [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            style: {
              width: 6,
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 12, opacity: 0.6 }, children: typingText }),
        /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
        @keyframes hermes-bounce {
          0%, 80%, 100% { transform: translateY(0); }
...
var PickerStyleTag = /* @__PURE__ */ React__default.memo(function PickerStyleTag2() {
...
function useDebouncedState(initialValue, delay) {
  ...
  var _useState = React__default.useState(initialValue), state = _useState[0], setState = _useState[1];
...
function useDisallowedEmojis() {
  var DisallowedEmojisRef = React__default.useRef({});
...
function PickerContextProvider(_ref) {
  ...
  var filterRef = React__default.useRef(searchIndex);
  React__default.useEffect(function() {
    filterRef.current = searchIndex;
  }, [searchIndex]);
  var disallowClickRef = React__default.useRef(false);
  var disallowMouseRef = React__default.useRef(false);
  var disallowedEmojisRef = React__default.useRef(disallowedEmojis);
  var suggestedUpdateState = useDebouncedState(Date.now(), 200);
  var searchTerm = useDebouncedState("", 100);
  var skinToneFanOpenState = React__default.useState(false);
  var activeSkinTone = React__default.useState(defaultSkinTone);
  var activeCategoryState = React__default.useState(null);
  var emojisThatFailedToLoadState = React__default.useState(/* @__PURE__ */ new Set());
  var emojiVariationPickerState = React__default.useState(null);
  var reactionsModeState = React__default.useState(reactionsDefaultOpen);
  var _useState = React__default.useState(false), isPastInitialLoad = _useState[0], setIsPastInitialLoad = _useState[1];
  var visibleCategoriesState = React__default.useState([]);
  var emojiSizeState = React__default.useState(null);
  useMarkInitialLoad(setIsPastInitialLoad);
  return React__default.createElement(PickerContext.Provider, {
    value: {
      activeCategoryState,
      activeSkinTone,
      disallowClickRef,
...
var PickerContext = /* @__PURE__ */ React__default.createContext({
...
function useFilterRef() {
  var _React$useContext = React__default.useContext(PickerContext), filterRef = _React$useContext.filterRef;
  return filterRef;
}
function useDisallowClickRef() {
  var _React$useContext2 = React__default.useContext(PickerContext), disallowClickRef = _React$useContext2.disallowClickRef;
  return disallowClickRef;
}
function useDisallowMouseRef() {
  var _React$useContext3 = React__default.useContext(PickerContext), disallowMouseRef = _React$useContext3.disallowMouseRef;
  return disallowMouseRef;
}
function useReactionsModeState() {
  var _React$useContext4 = React__default.useContext(PickerContext), reactionsModeState = _React$useContext4.reactionsModeState;
  return reactionsModeState;
}
function useSearchTermState() {
  var _React$useContext5 = React__default.useContext(PickerContext), searchTerm = _React$useContext5.searchTerm;
  return searchTerm;
}
function useActiveSkinToneState() {
  var _React$useContext6 = React__default.useContext(PickerContext), activeSkinTone = _React$useContext6.activeSkinTone;
  return activeSkinTone;
}
function useEmojisThatFailedToLoadState() {
  var _React$useContext7 = React__default.useContext(PickerContext), emojisThatFailedToLoadState = _React$useContext7.emojisThatFailedToLoadState;
  return emojisThatFailedToLoadState;
}
function useEmojiVariationPickerState() {
  var _React$useContext9 = React__default.useContext(PickerContext), emojiVariationPickerState = _React$useContext9.emojiVariationPickerState;
  return emojiVariationPickerState;
}
function useSkinToneFanOpenState() {
  var _React$useContext0 = React__default.useContext(PickerContext), skinToneFanOpenState = _React$useContext0.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useVisibleCategoriesState() {
  var _React$useContext10 = React__default.useContext(PickerContext), visibleCategoriesState = _React$useContext10.visibleCategoriesState;
  return visibleCategoriesState;
}
function useEmojiSizeState() {
  var _React$useContext11 = React__default.useContext(PickerContext), emojiSizeState = _React$useContext11.emojiSizeState;
  return emojiSizeState;
}
function useUpdateSuggested() {
  var _React$useContext12 = React__default.useContext(PickerContext), suggestedUpdateState = _React$useContext12.suggestedUpdateState;
...
function ElementRefContextProvider(_ref) {
  var children = _ref.children;
  var PickerMainRef = React__default.useRef(null);
  var AnchoredEmojiRef = React__default.useRef(null);
  var BodyRef = React__default.useRef(null);
  var EmojiListRef = React__default.useRef(null);
  var SearchInputRef = React__default.useRef(null);
  var SkinTonePickerRef = React__default.useRef(null);
  var CategoryNavigationRef = React__default.useRef(null);
  var VariationPickerRef = React__default.useRef(null);
  var ReactionsRef = React__default.useRef(null);
  return React__default.createElement(ElementRefContext.Provider, {
    value: {
      AnchoredEmojiRef,
      BodyRef,
      EmojiListRef,
...
var ElementRefContext = /* @__PURE__ */ React__default.createContext({
  AnchoredEmojiRef: /* @__PURE__ */ React__default.createRef(),
  BodyRef: /* @__PURE__ */ React__default.createRef(),
  CategoryNavigationRef: /* @__PURE__ */ React__default.createRef(),
  EmojiListRef: /* @__PURE__ */ React__default.createRef(),
  PickerMainRef: /* @__PURE__ */ React__default.createRef(),
  SearchInputRef: /* @__PURE__ */ React__default.createRef(),
  SkinTonePickerRef: /* @__PURE__ */ React__default.createRef(),
  VariationPickerRef: /* @__PURE__ */ React__default.createRef(),
  ReactionsRef: /* @__PURE__ */ React__default.createRef()
});
function useElementRef() {
  return React__default.useContext(ElementRefContext);
}
...
function useScrollTo() {
  ...
  return React__default.useCallback(function(top) {
    requestAnimationFrame(function() {
      if (BodyRef.current) {
...
function useCloseAllOpenToggles() {
  ...
  var closeAllOpenToggles = React__default.useCallback(function() {
    if (variationPicker) {
...
function usePickerMainKeyboardEvents() {
  ...
  var onKeyDown = React__default.useMemo(function() {
...
function useGoDownFromSearchInput() {
  ...
  var BodyRef = useBodyRef();
  return React__default.useCallback(function goDownFromSearchInput() {
    if (isSearchMode) {
...
function useGoUpFromBody() {
  ...
  var focusCategoryNavigation = useFocusCategoryNavigation();
  var isSearchMode = useIsSearchMode();
  return React__default.useCallback(function goUpFromEmoji() {
    if (isSearchMode) {
      return focusSearchInput();
    }
    return focusCategoryNavigation();
...
function PickerMain(_ref) {
  var children = _ref.children;
  return React__default.createElement(PickerContextProvider, null, React__default.createElement(PickerRootElement, null, children));
}
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  var mouseDownTimerRef = React__default.useRef();
  var setVariationPicker = useSetVariationPicker();
  ...
  var onClick = React__default.useCallback(function onClick2(event) {
  ...
  var onMouseDown = React__default.useCallback(function onMouseDown2(event) {
    var _window;
  ...
  var onMouseUp = React__default.useCallback(function onMouseUp2() {
    if (mouseDownTimerRef.current) {
      clearTimeout(mouseDownTimerRef.current);
      mouseDownTimerRef.current = void 0;
...
function ViewOnlyEmoji(_ref) {
  ...
  if (isCustomEmoji(emojiToRender)) {
    return React__default.createElement(EmojiImg, {
      style,
      emojiName: unified,
  ...
  return React__default.createElement(React__default.Fragment, null, emojiStyle === EmojiStyle.NATIVE ? React__default.createElement(NativeEmoji, {
    unified,
    style,
    className
  }) : React__default.createElement(EmojiImg, {
    style,
...
function ClickableEmoji(_ref) {
  ...
  return React__default.createElement(ClickableEmojiButton, {
    hasVariations,
    showVariations,
    hidden: hidden2,
    hiddenOnSearch,
    ...
    noBackground,
    style
  }, React__default.createElement(ViewOnlyEmoji, {
    unified,
    emoji,
    size,
    emojiStyle,
...
function Reactions() {
  ...
  return React__default.createElement("ul", {
    ...
    return React__default.createElement("li", {
      key: reaction
    }, React__default.createElement(ClickableEmoji, {
      emoji,
      emojiStyle,
      unified: reaction,
  ...
  }), allowExpandReactions ? React__default.createElement("li", null, React__default.createElement(BtnPlus, null)) : null);
}
...
function useOnScroll(BodyRef) {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var _useState = React__default.useState(0), scrollTop = _useState[0], setScrollTop = _useState[1];
  React__default.useEffect(function() {
    var bodyRef = BodyRef.current;
    if (!bodyRef) {
      return;
...
function useCategoryHeight(emojiCount) {
  ...
  var PickerMainRef = usePickerMainRef();
  var emojiSizeRef = React__default.useRef();
  ...
  var _React$useState = React__default.useState(), dimensions = _React$useState[0], setDimensions = _React$useState[1];
  var computeAndSetDimensions = React__default.useCallback(function() {
...
function useEmojiVirtualization(_ref) {
  ...
  var emojis2 = emojisToPush.reduce(function(accumulator, emoji, index) {
    ...
    accumulator.push(React__default.createElement(ClickableEmoji, {
      showVariations,
      key: unified,
      emoji,
      unified,
...
function EmojiCategory(_ref) {
  ...
  }, categoryName), React__default.createElement("div", {
...
function EmojiList(_ref) {
  ...
  var categories2 = useCategoriesConfig();
  var _React$useState = React__default.useState({}), categoryHeights = _React$useState[0], setCategoryHeights = _React$useState[1];
  var EmojiListRef = useEmojiListRef();
  ...
  return React__default.createElement("ul", {
    ...
    ref: EmojiListRef
  }, React__default.createElement(MeasureEmoji, null), categories2.map(function(categoryConfig) {
    var category = categoryFromCategoryConfig(categoryConfig);
    ...
    return React__default.createElement(React__default.Suspense, {
      key: category
    }, React__default.createElement(RenderCategory, {
...
function RenderCategory(_ref2) {
  ...
  return React__default.createElement(EmojiCategory, {
    categoryConfig,
...
function EmojiVariationPicker() {
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement(ClickableEmoji, {
      key: unified,
      emoji,
      unified,
      emojiStyle,
...
function Body() {
  ...
  return React__default.createElement("div", {
    ...
    ref: BodyRef
  }, React__default.createElement(EmojiVariationPicker, null), React__default.createElement(EmojiList, {
    scrollTop
  }));
}
...
function SkinTonePickerMenu() {
  ...
  }, React__default.createElement(Absolute, {
    style: {
      bottom: 0,
      right: 0
    }
  }, React__default.createElement(SkinTonePicker, {
...
function SkinTonePicker(_ref) {
  ...
  return React__default.createElement(Relative, {
    ...
    return React__default.createElement(BtnSkinToneVariation, {
...
function Preview() {
  ...
  }, React__default.createElement(PreviewBody, null), React__default.createElement(Space, null), isSkinToneInPreview ? React__default.createElement(SkinTonePickerMenu, null) : null);
}
function PreviewBody() {
  var _previewEmoji$unified;
  var previewConfig = usePreviewConfig();
  var _useState = React__default.useState(null), previewEmoji = _useState[0], setPreviewEmoji = _useState[1];
  var emojiStyle = useEmojiStyleConfig();
  ...
  return React__default.createElement(PreviewContent, null);
  function PreviewContent() {
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", null, show ? React__default.createElement(ViewOnlyEmoji, {
    ...
    }) : defaultEmoji ? React__default.createElement(ViewOnlyEmoji, {
...
function CategoryNavigation() {
  var _useState = React__default.useState(null), activeCategory = _useState[0], setActiveCategory = _useState[1];
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement(CategoryButton, {
      key: category,
      category,
      isActiveCategory,
      allowNavigation,
...
function SearchContainer() {
  ...
  }, React__default.createElement(Search, null), isSkinToneInSearch ? React__default.createElement(SkinTonePicker, null) : null);
}
function Search() {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var SearchInputRef = useSearchInputRef();
  ...
  return React__default.createElement(Relative, {
    ...
    ref: SearchInputRef
  }), searchTerm ? React__default.createElement("div", {
    role: "status",
    className: cx("epr-status-search-results", styles$j.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, React__default.createElement(IcnSearch, null), React__default.createElement(BtnClearSearch, null));
}
...
function Header() {
  ...
  }, React__default.createElement(SearchContainer, null), React__default.createElement(CategoryNavigation, null));
}
function EmojiPicker(props) {
  return React__default.createElement(ElementRefContextProvider, null, React__default.createElement(PickerStyleTag, null), React__default.createElement(PickerConfigProvider, Object.assign({}, props), React__default.createElement(PickerDataProvider, null, React__default.createElement(ContentControl, null))));
}
function ContentControl() {
  var _useReactionsModeStat = useReactionsModeState(), reactionsDefaultOpen = _useReactionsModeStat[0];
  var allowExpandReactions = useAllowExpandReactions();
  var _React$useState = React__default.useState(!reactionsDefaultOpen), renderAll = _React$useState[0], setRenderAll = _React$useState[1];
  ...
  return React__default.createElement(PickerMain, null, React__default.createElement(Reactions, null), React__default.createElement(ExpandedPickerContent, {
    renderAll
  }));
}
function ExpandedPickerContent(_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(Header, null), React__default.createElement(Body, null), React__default.createElement(Preview, null));
}
var EmojiPickerReact = /* @__PURE__ */ React__default.memo(EmojiPicker, compareConfig);
...
function EmojiPicker$1(props) {
  ...
  return React__default.createElement(ErrorBoundary, null, React__default.createElement(MutableConfigContext.Provider, {
    value: MutableConfigRef
  }, React__default.createElement(EmojiPickerReact, Object.assign({}, props))));
}
...
const ReactionPicker = ({
  ...
  const hasReacted = (emoji) => {
    ...
    return ((_a = currentReactions.find((r) => r.emoji === emoji)) == null ? void 0 : _a.users.includes(currentUserId)) ?? false;
  };
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            ...
            children: [
              emojis2.map((emoji) => /* @__PURE__ */ jsxRuntime.jsx(
                "button",
                {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        message.type === "audio" && /* @__PURE__ */ jsxRuntime.jsxs(
          "div",
          {
            style: { display: "flex", alignItems: "center", gap: 8, padding: 8 },
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 20 }, children: "🎵" }),
              /* @__PURE__ */ jsxRuntime.jsx("audio", { src: message.url, controls: true, style: { flex: 1, height: 36 } })
            ]
          }
        ),
        message.type === "document" && /* @__PURE__ */ jsxRuntime.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 28, flexShrink: 0 }, children: "📄" }),
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { overflow: "hidden" }, children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontSize: 11, opacity: 0.6 }, children: [
        ...
        message.type === "link" && /* @__PURE__ */ jsxRuntime.jsxs(
          "a",
          {
            href: message.url,
            target: "_blank",
...
exports.OnlineBadge = OnlineBadge;
