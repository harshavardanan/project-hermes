...
import { useState as useState12, useRef as useRef9, useEffect as useEffect11 } from "react";

// node_modules/emoji-picker-react/dist/emoji-picker-react.esm.js
import React__default, { memo, createElement, useState as useState11, useEffect as useEffect10, useContext as useContext7, createContext as createContext7, useRef as useRef8, useMemo as useMemo3, createRef, useCallback as useCallback11, Fragment as Fragment3, useLayoutEffect, Suspense, Component } from "react";
...
var ConfigContext = /* @__PURE__ */ createContext7(/* @__PURE__ */ basePickerConfig());
...
function usePickerConfig() {
  return useContext7(ConfigContext);
}
function useDebouncedState(initialValue, delay) {
  if (delay === void 0) {
    delay = 0;
  }
  var _useState = useState11(initialValue), state = _useState[0], setState = _useState[1];
  var timer = useRef8(null);
...
function useDisallowedEmojis() {
  var DisallowedEmojisRef = useRef8({});
...
function PickerContextProvider(_ref) {
  ...
  var filterRef = useRef8(searchIndex);
  useEffect10(function() {
    filterRef.current = searchIndex;
  }, [searchIndex]);
  var disallowClickRef = useRef8(false);
  var disallowMouseRef = useRef8(false);
  var disallowedEmojisRef = useRef8(disallowedEmojis);
  var suggestedUpdateState = useDebouncedState(Date.now(), 200);
  var searchTerm = useDebouncedState("", 100);
  var skinToneFanOpenState = useState11(false);
  var activeSkinTone = useState11(defaultSkinTone);
  var activeCategoryState = useState11(null);
  var emojisThatFailedToLoadState = useState11(/* @__PURE__ */ new Set());
  var emojiVariationPickerState = useState11(null);
  var reactionsModeState = useState11(reactionsDefaultOpen);
  var _useState = useState11(false), isPastInitialLoad = _useState[0], setIsPastInitialLoad = _useState[1];
  var visibleCategoriesState = useState11([]);
  var emojiSizeState = useState11(null);
...
var PickerContext = /* @__PURE__ */ createContext7({
...
function useFilterRef() {
  var _React$useContext = useContext7(PickerContext), filterRef = _React$useContext.filterRef;
  return filterRef;
}
function useDisallowClickRef() {
  var _React$useContext2 = useContext7(PickerContext), disallowClickRef = _React$useContext2.disallowClickRef;
  return disallowClickRef;
}
function useDisallowMouseRef() {
  var _React$useContext3 = useContext7(PickerContext), disallowMouseRef = _React$useContext3.disallowMouseRef;
  return disallowMouseRef;
}
function useReactionsModeState() {
  var _React$useContext4 = useContext7(PickerContext), reactionsModeState = _React$useContext4.reactionsModeState;
  return reactionsModeState;
}
function useSearchTermState() {
  var _React$useContext5 = useContext7(PickerContext), searchTerm = _React$useContext5.searchTerm;
  return searchTerm;
}
function useActiveSkinToneState() {
  var _React$useContext6 = useContext7(PickerContext), activeSkinTone = _React$useContext6.activeSkinTone;
  return activeSkinTone;
}
function useEmojisThatFailedToLoadState() {
  var _React$useContext7 = useContext7(PickerContext), emojisThatFailedToLoadState = _React$useContext7.emojisThatFailedToLoadState;
  return emojisThatFailedToLoadState;
}
function useEmojiVariationPickerState() {
  var _React$useContext9 = useContext7(PickerContext), emojiVariationPickerState = _React$useContext9.emojiVariationPickerState;
  return emojiVariationPickerState;
}
function useSkinToneFanOpenState() {
  var _React$useContext0 = useContext7(PickerContext), skinToneFanOpenState = _React$useContext0.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useVisibleCategoriesState() {
  var _React$useContext10 = useContext7(PickerContext), visibleCategoriesState = _React$useContext10.visibleCategoriesState;
  return visibleCategoriesState;
}
function useEmojiSizeState() {
  var _React$useContext11 = useContext7(PickerContext), emojiSizeState = _React$useContext11.emojiSizeState;
  return emojiSizeState;
}
function useUpdateSuggested() {
  var _React$useContext12 = useContext7(PickerContext), suggestedUpdateState = _React$useContext12.suggestedUpdateState;
...
function ElementRefContextProvider(_ref) {
  var children = _ref.children;
  var PickerMainRef = useRef8(null);
  var AnchoredEmojiRef = useRef8(null);
  var BodyRef = useRef8(null);
  var EmojiListRef = useRef8(null);
  var SearchInputRef = useRef8(null);
  var SkinTonePickerRef = useRef8(null);
  var CategoryNavigationRef = useRef8(null);
  var VariationPickerRef = useRef8(null);
  var ReactionsRef = useRef8(null);
...
var ElementRefContext = /* @__PURE__ */ createContext7({
...
function useElementRef() {
  return useContext7(ElementRefContext);
}
...
function useScrollTo() {
  ...
  return useCallback11(function(top) {
    requestAnimationFrame(function() {
      if (BodyRef.current) {
...
function useCloseAllOpenToggles() {
  ...
  var closeAllOpenToggles = useCallback11(function() {
    if (variationPicker) {
...
function usePickerMainKeyboardEvents() {
  ...
  var onKeyDown = useMemo3(function() {
...
function useGoDownFromSearchInput() {
  ...
  var BodyRef = useBodyRef();
  return useCallback11(function goDownFromSearchInput() {
    if (isSearchMode) {
...
function useGoUpFromBody() {
  ...
  var focusCategoryNavigation = useFocusCategoryNavigation();
  var isSearchMode = useIsSearchMode();
  return useCallback11(function goUpFromEmoji() {
    if (isSearchMode) {
      return focusSearchInput();
    }
    return focusCategoryNavigation();
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  ...
  var onClick = useCallback11(function onClick2(event) {
  ...
  var onMouseDown = useCallback11(function onMouseDown2(event) {
    var _window;
  ...
  var onMouseUp = useCallback11(function onMouseUp2() {
    if (mouseDownTimerRef.current) {
      clearTimeout(mouseDownTimerRef.current);
      mouseDownTimerRef.current = void 0;
...
function ViewOnlyEmoji(_ref) {
  ...
  return createElement(Fragment3, null, emojiStyle === EmojiStyle.NATIVE ? createElement(NativeEmoji, {
    unified,
    style,
    className
...
function useOnScroll(BodyRef) {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var _useState = useState11(0), scrollTop = _useState[0], setScrollTop = _useState[1];
  useEffect10(function() {
    var bodyRef = BodyRef.current;
    if (!bodyRef) {
      return;
...
function useCategoryHeight(emojiCount) {
  ...
  var _React$useState = useState11(), dimensions = _React$useState[0], setDimensions = _React$useState[1];
  var computeAndSetDimensions = useCallback11(function() {
...
function EmojiList(_ref) {
  ...
  var categories2 = useCategoriesConfig();
  var _React$useState = useState11({}), categoryHeights = _React$useState[0], setCategoryHeights = _React$useState[1];
  var EmojiListRef = useEmojiListRef();
...
function PreviewBody() {
  ...
  var previewConfig = usePreviewConfig();
  var _useState = useState11(null), previewEmoji = _useState[0], setPreviewEmoji = _useState[1];
  var emojiStyle = useEmojiStyleConfig();
  ...
  function PreviewContent() {
    ...
    return createElement(Fragment3, null, createElement("div", null, show ? createElement(ViewOnlyEmoji, {
...
function CategoryNavigation() {
  var _useState = useState11(null), activeCategory = _useState[0], setActiveCategory = _useState[1];
...
function ContentControl() {
  ...
  var allowExpandReactions = useAllowExpandReactions();
  var _React$useState = useState11(!reactionsDefaultOpen), renderAll = _React$useState[0], setRenderAll = _React$useState[1];
...
function ExpandedPickerContent(_ref) {
  ...
  return createElement(Fragment3, null, createElement(Header, null), createElement(Body, null), createElement(Preview, null));
}
      ...
      children: [
        /* @__PURE__ */ jsxs11(
          "div",
          {
            ...
            children: [
              emojis2.map((emoji) => /* @__PURE__ */ jsx22(
                "button",
                {
...
import { useEffect as useEffect12, useCallback as useCallback12 } from "react";
...
import { useState as useState13, useCallback as useCallback13, useMemo as useMemo4 } from "react";
