...
var Room = ({
  ...
  const componentOverrides = (0, import_react15.useMemo)(
    ...
    [Avatar2, MessageOverride, MessageStatus2, MessageActions2, DateSeparator2, EmptyStateIndicator2, LoadingIndicator2, LoadingErrorIndicator2, ReactionPicker2, TypingIndicator2, MediaMessage2, ThreadHeader2, Modal2, ChatInput2, RoomListItem, Search3, OnlineBadge2]
  );
...
var PickerStyleTag = /* @__PURE__ */ (0, import_react19.memo)(function PickerStyleTag2() {
  return (0, import_react19.createElement)("style", {
...
var ConfigContext = /* @__PURE__ */ (0, import_react19.createContext)(/* @__PURE__ */ basePickerConfig());
function PickerConfigProvider(_ref) {
  ...
  return (0, import_react19.createElement)(ConfigContext.Provider, {
    value: mergedConfig
  }, children);
}
function useSetConfig(config) {
  var _config$customEmojis;
  var _React$useState = (0, import_react19.useState)(function() {
...
function useDebouncedState(initialValue, delay) {
  ...
  var _useState = (0, import_react19.useState)(initialValue), state = _useState[0], setState = _useState[1];
  var timer = (0, import_react19.useRef)(null);
...
function useGetEmojisByCategory() {
  ...
  var suggested = import_react19.default.useMemo(
    function() {
      var _getSuggested;
...
var PickerDataContext = /* @__PURE__ */ import_react19.default.createContext({
  emojiData: {},
  allEmojis: [],
  allEmojisByUnified: {},
  searchIndex: {},
...
function PickerDataProvider(_ref) {
  ...
  var data = import_react19.default.useMemo(function() {
  ...
  var emojiByUnified2 = import_react19.default.useCallback(function(unified) {
  ...
  return import_react19.default.createElement(PickerDataContext.Provider, {
    value: _extends({}, data, {
...
function usePickerDataContext() {
  return import_react19.default.useContext(PickerDataContext);
}
function useGetEmojisByCategory$1() {
  ...
  var suggestedEmojisModeConfig = useSuggestedEmojisModeConfig();
  var _useUpdateSuggested = useUpdateSuggested(), suggestedUpdated = _useUpdateSuggested[0];
  var suggested = import_react19.default.useMemo(function() {
    var _getSuggested;
    var suggested2 = (_getSuggested = getSuggested(suggestedEmojisModeConfig)) != null ? _getSuggested : [];
    return suggested2.map(function(s) {
      var _extends2;
...
function useDisallowedEmojis() {
  var DisallowedEmojisRef = (0, import_react19.useRef)({});
...
function PickerContextProvider(_ref) {
  ...
  var filterRef = (0, import_react19.useRef)(searchIndex);
  (0, import_react19.useEffect)(function() {
    filterRef.current = searchIndex;
  }, [searchIndex]);
  var disallowClickRef = (0, import_react19.useRef)(false);
  var disallowMouseRef = (0, import_react19.useRef)(false);
  var disallowedEmojisRef = (0, import_react19.useRef)(disallowedEmojis);
  var suggestedUpdateState = useDebouncedState(Date.now(), 200);
  var searchTerm = useDebouncedState("", 100);
  var skinToneFanOpenState = (0, import_react19.useState)(false);
  var activeSkinTone = (0, import_react19.useState)(defaultSkinTone);
  var activeCategoryState = (0, import_react19.useState)(null);
  var emojisThatFailedToLoadState = (0, import_react19.useState)(/* @__PURE__ */ new Set());
  var emojiVariationPickerState = (0, import_react19.useState)(null);
  var reactionsModeState = (0, import_react19.useState)(reactionsDefaultOpen);
  var _useState = (0, import_react19.useState)(false), isPastInitialLoad = _useState[0], setIsPastInitialLoad = _useState[1];
  var visibleCategoriesState = (0, import_react19.useState)([]);
  var emojiSizeState = (0, import_react19.useState)(null);
  useMarkInitialLoad(setIsPastInitialLoad);
  return (0, import_react19.createElement)(PickerContext.Provider, {
    value: {
      activeCategoryState,
      activeSkinTone,
      disallowClickRef,
...
var PickerContext = /* @__PURE__ */ (0, import_react19.createContext)({
...
function useFilterRef() {
  var _React$useContext = (0, import_react19.useContext)(PickerContext), filterRef = _React$useContext.filterRef;
  return filterRef;
}
function useDisallowClickRef() {
  var _React$useContext2 = (0, import_react19.useContext)(PickerContext), disallowClickRef = _React$useContext2.disallowClickRef;
  return disallowClickRef;
}
function useDisallowMouseRef() {
  var _React$useContext3 = (0, import_react19.useContext)(PickerContext), disallowMouseRef = _React$useContext3.disallowMouseRef;
  return disallowMouseRef;
}
function useReactionsModeState() {
  var _React$useContext4 = (0, import_react19.useContext)(PickerContext), reactionsModeState = _React$useContext4.reactionsModeState;
  return reactionsModeState;
}
function useSearchTermState() {
  var _React$useContext5 = (0, import_react19.useContext)(PickerContext), searchTerm = _React$useContext5.searchTerm;
  return searchTerm;
}
function useActiveSkinToneState() {
  var _React$useContext6 = (0, import_react19.useContext)(PickerContext), activeSkinTone = _React$useContext6.activeSkinTone;
  return activeSkinTone;
}
function useEmojisThatFailedToLoadState() {
  var _React$useContext7 = (0, import_react19.useContext)(PickerContext), emojisThatFailedToLoadState = _React$useContext7.emojisThatFailedToLoadState;
  return emojisThatFailedToLoadState;
}
function useEmojiVariationPickerState() {
  var _React$useContext9 = (0, import_react19.useContext)(PickerContext), emojiVariationPickerState = _React$useContext9.emojiVariationPickerState;
  return emojiVariationPickerState;
}
function useSkinToneFanOpenState() {
  var _React$useContext0 = (0, import_react19.useContext)(PickerContext), skinToneFanOpenState = _React$useContext0.skinToneFanOpenState;
  return skinToneFanOpenState;
}
function useVisibleCategoriesState() {
  var _React$useContext10 = (0, import_react19.useContext)(PickerContext), visibleCategoriesState = _React$useContext10.visibleCategoriesState;
  return visibleCategoriesState;
}
function useEmojiSizeState() {
  var _React$useContext11 = (0, import_react19.useContext)(PickerContext), emojiSizeState = _React$useContext11.emojiSizeState;
  return emojiSizeState;
}
function useUpdateSuggested() {
  var _React$useContext12 = (0, import_react19.useContext)(PickerContext), suggestedUpdateState = _React$useContext12.suggestedUpdateState;
...
var MutableConfigContext = /* @__PURE__ */ import_react19.default.createContext({});
function useMutableConfig() {
  var mutableConfig = import_react19.default.useContext(MutableConfigContext);
  return mutableConfig;
}
function useDefineMutableConfig(config) {
  var MutableConfigRef = import_react19.default.useRef({
...
function ElementRefContextProvider(_ref) {
  var children = _ref.children;
  var PickerMainRef = (0, import_react19.useRef)(null);
  var AnchoredEmojiRef = (0, import_react19.useRef)(null);
  var BodyRef = (0, import_react19.useRef)(null);
  var EmojiListRef = (0, import_react19.useRef)(null);
  var SearchInputRef = (0, import_react19.useRef)(null);
  var SkinTonePickerRef = (0, import_react19.useRef)(null);
  var CategoryNavigationRef = (0, import_react19.useRef)(null);
  var VariationPickerRef = (0, import_react19.useRef)(null);
  var ReactionsRef = (0, import_react19.useRef)(null);
  return (0, import_react19.createElement)(ElementRefContext.Provider, {
    value: {
      AnchoredEmojiRef,
      BodyRef,
      EmojiListRef,
...
var ElementRefContext = /* @__PURE__ */ (0, import_react19.createContext)({
  AnchoredEmojiRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  BodyRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  CategoryNavigationRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  EmojiListRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  PickerMainRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  SearchInputRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  SkinTonePickerRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  VariationPickerRef: /* @__PURE__ */ (0, import_react19.createRef)(),
  ReactionsRef: /* @__PURE__ */ (0, import_react19.createRef)()
});
function useElementRef() {
  return (0, import_react19.useContext)(ElementRefContext);
}
...
function useScrollTo() {
  ...
  return (0, import_react19.useCallback)(function(top) {
    requestAnimationFrame(function() {
      if (BodyRef.current) {
...
function useCloseAllOpenToggles() {
  ...
  var closeAllOpenToggles = (0, import_react19.useCallback)(function() {
    if (variationPicker) {
...
function useFocusSearchInput() {
  ...
  return (0, import_react19.useCallback)(function() {
...
function usePickerMainKeyboardEvents() {
  ...
  var onKeyDown = (0, import_react19.useMemo)(function() {
...
function useGoDownFromSearchInput() {
  ...
  var BodyRef = useBodyRef();
  return (0, import_react19.useCallback)(function goDownFromSearchInput() {
    if (isSearchMode) {
...
function useGoUpFromBody() {
  ...
  var focusCategoryNavigation = useFocusCategoryNavigation();
  var isSearchMode = useIsSearchMode();
  return (0, import_react19.useCallback)(function goUpFromEmoji() {
    if (isSearchMode) {
      return focusSearchInput();
    }
    return focusCategoryNavigation();
...
function PickerMain(_ref) {
  var children = _ref.children;
  return (0, import_react19.createElement)(PickerContextProvider, null, (0, import_react19.createElement)(PickerRootElement, null, children));
}
function PickerRootElement(_ref2) {
  ...
  return (0, import_react19.createElement)("aside", {
...
function useMouseDownHandlers(ContainerRef, mouseEventSource) {
  var mouseDownTimerRef = (0, import_react19.useRef)();
  var setVariationPicker = useSetVariationPicker();
  ...
  var onClick = (0, import_react19.useCallback)(function onClick2(event) {
  ...
  var onMouseDown = (0, import_react19.useCallback)(function onMouseDown2(event) {
    var _window;
  ...
  var onMouseUp = (0, import_react19.useCallback)(function onMouseUp2() {
    if (mouseDownTimerRef.current) {
      clearTimeout(mouseDownTimerRef.current);
      mouseDownTimerRef.current = void 0;
...
function Button(props) {
  return (0, import_react19.createElement)("button", Object.assign({
    type: "button"
  }, props, {
...
function ClickableEmojiButton(_ref) {
  ...
  return (0, import_react19.createElement)(Button, {
...
function EmojiImg(_ref) {
  ...
  return (0, import_react19.createElement)("img", {
    src: imgUrl,
    alt: emojiName2,
...
function ViewOnlyEmoji(_ref) {
  ...
  if (isCustomEmoji(emojiToRender)) {
    return (0, import_react19.createElement)(EmojiImg, {
      style,
      emojiName: unified,
  ...
  return (0, import_react19.createElement)(import_react19.Fragment, null, emojiStyle === EmojiStyle.NATIVE ? (0, import_react19.createElement)(NativeEmoji, {
    unified,
    style,
    className
  }) : (0, import_react19.createElement)(EmojiImg, {
    style,
...
function ClickableEmoji(_ref) {
  ...
  return (0, import_react19.createElement)(ClickableEmojiButton, {
    hasVariations,
    showVariations,
    hidden: hidden2,
    hiddenOnSearch,
    ...
    noBackground,
    style
  }, (0, import_react19.createElement)(ViewOnlyEmoji, {
    unified,
    emoji,
    size,
    emojiStyle,
...
function Reactions() {
  ...
  return (0, import_react19.createElement)("ul", {
    ...
    return (0, import_react19.createElement)("li", {
      key: reaction
    }, (0, import_react19.createElement)(ClickableEmoji, {
      emoji,
      emojiStyle,
      unified: reaction,
  ...
  }), allowExpandReactions ? (0, import_react19.createElement)("li", null, (0, import_react19.createElement)(BtnPlus, null)) : null);
}
...
function useOnScroll(BodyRef) {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var _useState = (0, import_react19.useState)(0), scrollTop = _useState[0], setScrollTop = _useState[1];
  (0, import_react19.useEffect)(function() {
    var bodyRef = BodyRef.current;
    if (!bodyRef) {
      return;
...
function useCategoryHeight(emojiCount) {
  ...
  var PickerMainRef = usePickerMainRef();
  var emojiSizeRef = (0, import_react19.useRef)();
  ...
  var _React$useState = (0, import_react19.useState)(), dimensions = _React$useState[0], setDimensions = _React$useState[1];
  var computeAndSetDimensions = (0, import_react19.useCallback)(function() {
...
function useEmojiVirtualization(_ref) {
  ...
  var emojis2 = emojisToPush.reduce(function(accumulator, emoji, index) {
    ...
    accumulator.push((0, import_react19.createElement)(ClickableEmoji, {
      showVariations,
      key: unified,
      emoji,
      unified,
...
function EmojiCategory(_ref) {
  ...
  }, (0, import_react19.createElement)("h2", {
    className: cx(styles$7.label)
  }, categoryName), (0, import_react19.createElement)("div", {
...
function EmojiList(_ref) {
  ...
  var categories2 = useCategoriesConfig();
  var _React$useState = (0, import_react19.useState)({}), categoryHeights = _React$useState[0], setCategoryHeights = _React$useState[1];
  var EmojiListRef = useEmojiListRef();
  ...
  return (0, import_react19.createElement)("ul", {
    ...
    ref: EmojiListRef
  }, (0, import_react19.createElement)(MeasureEmoji, null), categories2.map(function(categoryConfig) {
    var category = categoryFromCategoryConfig(categoryConfig);
    ...
    return (0, import_react19.createElement)(import_react19.Suspense, {
      key: category
    }, (0, import_react19.createElement)(RenderCategory, {
...
function RenderCategory(_ref2) {
  ...
  return (0, import_react19.createElement)(EmojiCategory, {
    categoryConfig,
...
function EmojiVariationPicker() {
  ...
  return (0, import_react19.createElement)("div", {
    ...
    return (0, import_react19.createElement)(ClickableEmoji, {
      key: unified,
      emoji,
      unified,
      emojiStyle,
  ...
  }) : null, (0, import_react19.createElement)("div", {
...
function Body() {
  ...
  return (0, import_react19.createElement)("div", {
    ...
    ref: BodyRef
  }, (0, import_react19.createElement)(EmojiVariationPicker, null), (0, import_react19.createElement)(EmojiList, {
    scrollTop
  }));
}
...
function SkinTonePickerMenu() {
  return (0, import_react19.createElement)(Relative, {
    style: {
      height: ITEM_SIZE
    }
  }, (0, import_react19.createElement)(Absolute, {
    style: {
      bottom: 0,
      right: 0
    }
  }, (0, import_react19.createElement)(SkinTonePicker, {
...
function SkinTonePicker(_ref) {
  ...
  return (0, import_react19.createElement)(Relative, {
    ...
    return (0, import_react19.createElement)(BtnSkinToneVariation, {
...
function Preview() {
  ...
  return (0, import_react19.createElement)(Flex, {
    className: cx(styles$e.preview, commonInteractionStyles.hiddenOnReactions, reactionsOpen && styles$e.hideOnReactions)
  }, (0, import_react19.createElement)(PreviewBody, null), (0, import_react19.createElement)(Space, null), isSkinToneInPreview ? (0, import_react19.createElement)(SkinTonePickerMenu, null) : null);
}
function PreviewBody() {
  var _previewEmoji$unified;
  var previewConfig = usePreviewConfig();
  var _useState = (0, import_react19.useState)(null), previewEmoji = _useState[0], setPreviewEmoji = _useState[1];
  var emojiStyle = useEmojiStyleConfig();
  ...
  return (0, import_react19.createElement)(PreviewContent, null);
  function PreviewContent() {
    ...
    return (0, import_react19.createElement)(import_react19.Fragment, null, (0, import_react19.createElement)("div", null, show ? (0, import_react19.createElement)(ViewOnlyEmoji, {
    ...
    }) : defaultEmoji ? (0, import_react19.createElement)(ViewOnlyEmoji, {
...
function CategoryNavigation() {
  var _useState = (0, import_react19.useState)(null), activeCategory = _useState[0], setActiveCategory = _useState[1];
  ...
  return (0, import_react19.createElement)("div", {
    ...
    return (0, import_react19.createElement)(CategoryButton, {
      key: category,
      category,
      isActiveCategory,
      allowNavigation,
...
function SearchContainer() {
  ...
  }, (0, import_react19.createElement)(Search, null), isSkinToneInSearch ? (0, import_react19.createElement)(SkinTonePicker, null) : null);
}
function Search() {
  var closeAllOpenToggles = useCloseAllOpenToggles();
  var SearchInputRef = useSearchInputRef();
  ...
  return (0, import_react19.createElement)(Relative, {
  ...
  }, (0, import_react19.createElement)("input", {
    ...
    ref: SearchInputRef
  }), searchTerm ? (0, import_react19.createElement)("div", {
    role: "status",
    className: cx("epr-status-search-results", styles$j.visuallyHidden),
    "aria-live": "polite",
    id: "epr-search-id",
    "aria-atomic": "true"
  }, statusSearchResults) : null, (0, import_react19.createElement)(IcnSearch, null), (0, import_react19.createElement)(BtnClearSearch, null));
}
...
function Header() {
  ...
  }, (0, import_react19.createElement)(SearchContainer, null), (0, import_react19.createElement)(CategoryNavigation, null));
}
function EmojiPicker(props) {
  return (0, import_react19.createElement)(ElementRefContextProvider, null, (0, import_react19.createElement)(PickerStyleTag, null), (0, import_react19.createElement)(PickerConfigProvider, Object.assign({}, props), (0, import_react19.createElement)(PickerDataProvider, null, (0, import_react19.createElement)(ContentControl, null))));
}
function ContentControl() {
  var _useReactionsModeStat = useReactionsModeState(), reactionsDefaultOpen = _useReactionsModeStat[0];
  var allowExpandReactions = useAllowExpandReactions();
  var _React$useState = (0, import_react19.useState)(!reactionsDefaultOpen), renderAll = _React$useState[0], setRenderAll = _React$useState[1];
  ...
  return (0, import_react19.createElement)(PickerMain, null, (0, import_react19.createElement)(Reactions, null), (0, import_react19.createElement)(ExpandedPickerContent, {
    renderAll
  }));
}
function ExpandedPickerContent(_ref) {
  ...
  return (0, import_react19.createElement)(import_react19.Fragment, null, (0, import_react19.createElement)(Header, null), (0, import_react19.createElement)(Body, null), (0, import_react19.createElement)(Preview, null));
}
var EmojiPickerReact = /* @__PURE__ */ (0, import_react19.memo)(EmojiPicker, compareConfig);
...
function EmojiPicker$1(props) {
  ...
  return (0, import_react19.createElement)(ErrorBoundary, null, (0, import_react19.createElement)(MutableConfigContext.Provider, {
    value: MutableConfigRef
  }, (0, import_react19.createElement)(EmojiPickerReact, Object.assign({}, props))));
}
...
var ReactionPicker = ({
  ...
  const [showPicker, setShowPicker] = (0, import_react20.useState)(false);
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
          "div",
          {
            ...
            children: [
              emojis2.map((emoji) => /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
                "button",
                {
        ...
        showPicker && /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
              emoji_picker_react_esm_default,
              {
                theme: Theme.DARK,
...
var Search2 = ({
  ...
  const results = (0, import_react22.useMemo)(() => {
