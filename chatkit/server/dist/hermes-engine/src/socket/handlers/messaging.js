...
import { sendMessage, getHistory, deleteMessage, editMessage, } from "../../services/messageService.js";
import { logger } from "../../utils/logger.js";
export const handleMessaging = (socket, io) => {
    ...
    socket.on("message:send", async (data, ack) => {
        try {
            ...
            const { roomId, type, text, url, fileName, fileSize, mimeType, thumbnail, replyTo, } = data;
            if (!roomId || !type)
