...
router.get("/projects", async (req, res) => {
    try {
        ...
        await Project.updateMany({ userId, "usage.lastResetDate": { $lt: todayStart } }, { $set: { "usage.dailyTokens": 0, "usage.lastResetDate": new Date() } });
...
router.post("/projects/:projectId/track-tokens", async (req, res) => {
    try {
...
//# sourceMappingURL=ProjectsRoute.js.map