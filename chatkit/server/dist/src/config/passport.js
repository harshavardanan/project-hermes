...
const authHandler = async (profile, done, idField) => {
    try {
...
}, (_at, _rt, profile, done) => authHandler(profile, done, "googleId")));
passport.use(new GitHubStrategy({
    clientID: process.env.GITHUB_CLIENT_ID,
    clientSecret: process.env.GITHUB_CLIENT_SECRET,
    callbackURL: "/auth/github/callback",
}, (_at, _rt, profile, done) => authHandler(profile, done, "githubId")));
